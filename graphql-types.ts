...
export type SitePluginPluginOptionsCodegenPluginsOptions = {
  scalars?: Maybe<SitePluginPluginOptionsCodegenPluginsOptionsScalars>;
};

export type SitePluginPluginOptionsCodegenPluginsOptionsFilterInput = {
  scalars?: Maybe<SitePluginPluginOptionsCodegenPluginsOptionsScalarsFilterInput>;
};

export type SitePluginPluginOptionsCodegenPluginsOptionsScalars = {
  Date?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsCodegenPluginsOptionsScalarsFilterInput = {
...
export type TopPageQuery = { allContentfulBlogPost: { nodes: Array<Pick<ContentfulBlogPost, 'id' | 'slug'>> } };
...
export type PostQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'id' | 'slug' | 'createdAt' | 'tags' | 'title' | 'updatedAt'>
    & { body?: Maybe<(
      Pick<ContentfulBlogPostBodyTextNode, 'id'>
      & { childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'id' | 'html'>> }
    )>, description?: Maybe<(
      Pick<ContentfulBlogPostDescriptionTextNode, 'id'>
      & { childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'id' | 'html'>> }
    )>, heroImage?: Maybe<(
...
export type AllPostsQuery = { allContentfulBlogPost: { nodes: Array<Pick<ContentfulBlogPost, 'id' | 'slug'>> } };
