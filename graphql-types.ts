...
export type SitePluginPluginOptionsCodegenPluginsOptionsFilterInput = {
  scalars?: Maybe<
    SitePluginPluginOptionsCodegenPluginsOptionsScalarsFilterInput
  >
}
...
export type PostQuery = {
  contentfulBlogPost?: Maybe<
    Pick<
      ContentfulBlogPost,
      'id' | 'slug' | 'createdAt' | 'tags' | 'title' | 'updatedAt'
    > & {
      body?: Maybe<
...
export type AllPostsQuery = {
  allContentfulBlogPost: {
    nodes: Array<Pick<ContentfulBlogPost, 'id' | 'slug'>>
  }
}
